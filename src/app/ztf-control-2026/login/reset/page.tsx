        ...
        <div className="bg-[#0D1F3C] rounded-2xl border border-[#C9A84C]/25 shadow-2xl p-7 sm:p-8">
          {sent ? (
            <div className="text-center py-4">
              ...
              <Link href="/ztf-control-2026/login" className="inline-flex items-center gap-2 text-[#C9A84C] hover:text-white text-sm transition">
            ...
            <>
              ...
              <div className="space-y-4">
                ...
                <Link href="/ztf-control-2026/login" className="flex items-center justify-center gap-2 text-gray-500 hover:text-gray-300 text-sm transition">
                  <ArrowLeft className="w-4 h-4" /> Back to Login
                </Link>
              </div>
            </>
